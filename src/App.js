...
// Sample Drone Data (You can later replace this with the actual dataset)
  ...
  function App() {
    ...
    return (
      <div className="App">
        ...
        {/* Pass setResponse to QueryInput to update response when a query is submitted */}
        <QueryInput setResponse={setResponse} />
        <DroneDataTable data={droneData} />
        {/* Pass the response state to QueryResponse to display the result */}
